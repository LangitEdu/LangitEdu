...
const ModalKomunitas = (props)=>{
    ...
    useEffect(() => {
        setProfileTempUrl(`https://avatars.dicebear.com/api/identicon/${new Date().getTime()}.svg`)
    }, [])
    return (
        <> 
                    ...
                    <div className="row">
                        <div className="col-md-4">
                            <div className="profilpic mb-4" style={{maxWidth:'10rem',maxHeight:'10rem',overflow:'hidden',borderRadius:"100%"}}>
                                <img id="profilepic" src={ ProfileTempUrl} alt="Profile" className="img-fluid"/>
                            </div>
                        </div>
                        <div className="col-md-8">
                            ...
                            <div className="form-group">
                                ...
                                <input ref={props.namaKomunitasRef} className="form-control" type="text" onChange={handleInputChange} required/>
                            ...
                            <div className="form-group">
                                ...
                                <textarea ref={props.deskripsiKomunitasRef} className="form-control" rows="10"></textarea>
                            </div>
                        </div>
