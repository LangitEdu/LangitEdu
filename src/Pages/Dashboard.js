    ...
    <Wrapper screen={size.width}>
      ...
      <div className="container mt-5 min-vh-100">
        ...
        {success && (
          <Dismissible
            type="success"
            message="Email berhasil dikirim, silahkan cek inbox anda"
          />
        )}
        {Error && <Dismissible type="danger" message={Error} />}
        {!currentUser.emailVerified && (
          <NotDismissible
            type="warning"
            message={
              <>
                Harap Verifikasi Email anda, jika email tidak masuk silahkan
                mengajukan kirim ulang
                <br />
                <Link to="#" onClick={hendleResendEmailVerify}>
                  Kirim Ulang
                </Link>
              </>
            }
            ...
            <div className="col-md-3 mb-4">
              ...
              <div className="card mt-4">
                <div className="card-body d-flex justify-content-center flex-column align-items-center">
                  ...
                  <Link
                    className="btn-bordered-blue shadow-sm"
                    to={RouteName.editProfile}
                  >
                    Edit Profile
                  </Link>
                </div>
