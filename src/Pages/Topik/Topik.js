                            ...
                            <div key={i} className="journeybox">
                                ...
                                <Link className={`btn btn-see-journey ${IsMember ? '' : 'disabled'}`} to={`/journey/${each.uid}`} aria-disabled={IsMember} >
                                    <svg width="32" height="34" viewBox="0 0 32 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M2.79604 19.2742C2.79344 19.2742 2.79474 19.2742 2.79474 19.2742L22.6541 19.2742L22.061 19.55C21.4813 19.8244 20.9539 20.1979 20.5024 20.6535L12.8749 28.281C11.8703 29.2399 11.7016 30.7826 12.4749 31.9361C13.375 33.1653 15.1011 33.4322 16.3304 32.5321C16.4297 32.4594 16.5241 32.3801 16.6128 32.2947L30.4058 18.5017C31.4837 17.425 31.4846 15.6784 30.4079 14.6005L30.4058 14.5983L16.6128 0.805358C15.534 -0.270408 13.7874 -0.267994 12.7115 0.810789C12.6269 0.895702 12.5478 0.986045 12.4749 1.08122C11.7016 2.23474 11.8703 3.7774 12.8749 4.73636L20.4886 12.3777C20.8934 12.7828 21.3587 13.1226 21.8679 13.3846L22.6955 13.757L2.94524 13.757C1.53603 13.7046 1.20257e-05 14.6784 1.09422e-05 16.3464C1.09422e-05 18.348 1.3344 19.2742 2.79604 19.2742Z" fill="white"/>
                                    </svg>
                                </Link>
                            </div>
                        ))}
